...
exports.signup = async (req, res) => {
    const { firstname, lastname, email, password, address, phone, dob } = req.body;

    const customerid = generateRandomCustomerId();
    const query = `
        INSERT INTO customer (customerid, firstname, lastname, email, password, address, phone, dob)
        VALUES ($1, $2, $3, $4, $5, $6, $7, $8)
    `;
    try {
        await pool.query(query, [customerid, firstname, lastname, email, password, address, phone, dob]);
